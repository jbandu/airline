-- Migration: Create Agent Network Views (Complete Rewrite)
-- Created: 2025-11-08
-- Description: Drops and recreates agent network tables and views

-- Drop existing views first (if they exist)
DROP VIEW IF EXISTS v_agent_collaboration_edges;
DROP VIEW IF EXISTS v_agent_network;
...
-- Add helpful comment
COMMENT ON VIEW v_agent_network IS 'Materialized view of all active agents with their categories and metrics';
